...
if (isset($_REQUEST['login'])) {
    ...
    $userid=$conn->real_escape_string($_REQUEST['username']);
    $tmp_password=$conn->real_escape_string($_REQUEST['password']);
    // $password=base64_encode($tmp_password);
    $password=$tmp_password;
    $sql="SELECT id,username,password FROM users WHERE username='".$userid."' AND password='".$password."' LIMIT 1";
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="#" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">CareCure24</span>
                </a>
              </div><!-- End Logo -->
